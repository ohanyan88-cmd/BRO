...
Required environment variables remain the FINAL-1 variables: `BRO_MODEL_PROVIDER`, `BRO_MODEL_API_KEY`, `BRO_MODEL_NAME`, provider-specific `BRO_MODEL_API_URL` where required, `BRO_GITHUB_TOKEN`, `BRO_GITHUB_OWNER`, `BRO_GITHUB_REPOSITORY`, `BRO_GITHUB_ISSUE`, `BRO_INTELLIGENT_IDEMPOTENCY_KEY`, `BRO_INTELLIGENT_COMMENT_BODY`, and `BRO_INTELLIGENT_CONFIRMED_BY`.
...
Պահանջվող environment variable-ները նույն FINAL-1 variable-ներն են՝ `BRO_MODEL_PROVIDER`, `BRO_MODEL_API_KEY`, `BRO_MODEL_NAME`, անհրաժեշտության դեպքում provider-specific `BRO_MODEL_API_URL`, `BRO_GITHUB_TOKEN`, `BRO_GITHUB_OWNER`, `BRO_GITHUB_REPOSITORY`, `BRO_GITHUB_ISSUE`, `BRO_INTELLIGENT_IDEMPOTENCY_KEY`, `BRO_INTELLIGENT_COMMENT_BODY`, `BRO_INTELLIGENT_CONFIRMED_BY`։
